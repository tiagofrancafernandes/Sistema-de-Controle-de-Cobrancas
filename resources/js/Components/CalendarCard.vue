...
<template>
  <div
    class="w-full max-w-full rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
  >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              class="event invisible absolute left-2 z-99 mb-1 flex w-[200%] flex-col rounded-lg border-l-[3px] border-primary bg-gray px-3 py-1 text-left opacity-0 group-hover:visible group-hover:opacity-100 dark:bg-meta-4 md:visible md:w-[190%] md:opacity-100"
            >
