...
<template>
  <li class="relative" ref="target">
        ...
        <div
        v-show="dropdownOpen"
        class="absolute -right-16 mt-2.5 flex h-90 w-75 flex-col rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80"
        >
