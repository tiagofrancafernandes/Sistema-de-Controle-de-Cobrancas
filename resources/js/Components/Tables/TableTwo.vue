...
<template>
  ...
  >
    ...
    <!-- Table Header -->
    <div
      aaclass="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5"
      class="flex bg-gray-2 text-left dark:bg-meta-4 border-t border-stroke dark:border-strokedark"
    >
        <div class="min-w-[150px] py-4 px-4 font-medium text-black dark:text-white">
