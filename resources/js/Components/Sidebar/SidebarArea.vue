...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: 'CRUD index 2',
        route: 'dev.crud.index.v2',
        href: route('dev.crud.index.v2'),
        active: route().current('dev.crud.index.v2'),
      },
      {
        icon: `<svg
                  class="fill-current"
        ...
        label: 'CRUD comp. demo',
        route: 'dev.crud.demo.index',
        href: route('dev.crud.demo.index'),
        active: route().current('dev.crud.demo.index'),
      },
      {
        icon: `<svg
                  class="fill-current"
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
      ...
      <nav class="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
        <template v-for="menuGroup in menuGroups" :key="menuGroup.name">
          <div>
            <h3 class="mb-4 ml-4 text-sm font-light text-bodydark2">{{ menuGroup.name }}</h3>
      ...
      <!-- Sidebar Menu -->
        ...
        >
            ...
            <a
                ...
                target="_blank"
                rel="nofollow"
                class="flex items-center justify-center rounded-md bg-primary p-2 font-light text-white hover:bg-opacity-90"
            >
                Purchase Now
            </a>
        </div>
